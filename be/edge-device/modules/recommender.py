...
class ProductRecommender:
    ...
    def _load_product_catalog(self):
        ...
        categories = {
            'Beverage': [
                {'id': 'BEV001', 'name': 'Coca Cola', 'price': 15000, 'popularity': 0.9},
                {'id': 'BEV002', 'name': 'Pepsi', 'price': 14000, 'popularity': 0.8},
                {'id': 'BEV003', 'name': 'Trà xanh', 'price': 10000, 'popularity': 0.85},
                {'id': 'BEV004', 'name': 'Nước suối', 'price': 5000, 'popularity': 0.95},
                {'id': 'BEV005', 'name': 'Sting', 'price': 12000, 'popularity': 0.7},
            ],
            'Snack': [
                {'id': 'SNK001', 'name': 'Lay\'s Chips', 'price': 20000, 'popularity': 0.85},
                {'id': 'SNK002', 'name': 'Oishi Snack', 'price': 10000, 'popularity': 0.8},
                {'id': 'SNK003', 'name': 'Poca', 'price': 15000, 'popularity': 0.75},
                {'id': 'SNK004', 'name': 'Bánh quy', 'price': 25000, 'popularity': 0.7},
            ],
            'Personal Care': [
                {'id': 'PC001', 'name': 'Kem đánh răng', 'price': 35000, 'popularity': 0.6},
                {'id': 'PC002', 'name': 'Dầu gội', 'price': 80000, 'popularity': 0.5},
                {'id': 'PC003', 'name': 'Xà phòng', 'price': 20000, 'popularity': 0.65},
            ],
            'Dairy': [
                {'id': 'DRY001', 'name': 'Sữa tươi Vinamilk', 'price': 30000, 'popularity': 0.85},
                {'id': 'DRY002', 'name': 'Sữa chua', 'price': 8000, 'popularity': 0.9},
                {'id': 'DRY003', 'name': 'Phô mai', 'price': 45000, 'popularity': 0.6},
            ],
            'Instant Food': [
                {'id': 'IF001', 'name': 'Mì Hảo Hảo', 'price': 5000, 'popularity': 0.95},
                {'id': 'IF002', 'name': 'Cơm hộp', 'price': 25000, 'popularity': 0.7},
                {'id': 'IF003', 'name': 'Bánh mì sandwich', 'price': 20000, 'popularity': 0.75},
            ]
        }
    ...
    def get_recommendations(self, face_attributes: Dict, customer_id: str = None, top_k: int = 5) -> List[Dict]:
        """
